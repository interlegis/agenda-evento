...
urlpatterns = [
    ...
    url(r'^api/pedido/(?P<pk>\d+)/$', views.ReservaDetail.as_view(),name='detail-pedido'),
    url(r'^api/pedido/(?P<pk>\d+)/evento/$', views.EventoDetail.as_view(),name='detail-pedido-evento'),
