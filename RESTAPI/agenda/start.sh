...
create_env() {
    ...
    echo "SESSION_COOKIE_SECURE" = ""${SESSION_COOKIE_SECURE-''} >> $FILENAME
    echo "CSRF_COOKIE_SECURE" = ""${CSRF_COOKIE_SECURE-''} >> $FILENAME
    echo "SECURE_BROWSER_XSS_FILTER" = ""${SECURE_BROWSER_XSS_FILTER-''} >> $FILENAME
    echo "SECURE_CONTENT_TYPE_NOSNIFF" = ""${SECURE_CONTENT_TYPE_NOSNIFF-''} >> $FILENAME
    echo "X_FRAME_OPTIONS" = ""${X_FRAME_OPTIONS-''} >> $FILENAME
